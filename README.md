...
## Authors
This project was authored by Nathan McCormick, Adam Alkawaz, and Ogochukwu Ibe-Ikechi at the University of Kansas' HackKU hackathon on April 17 - 19, 2026. We pursued the Ripple sponsor track, which involved building cutting-edge technology on the XRP blockchain to solve real world problems. For visuals, demos, and more information about the development process, check out the DevPost submission [here](https://devpost.com/software/blocksale). Block Party was brought from ideation to production in less than 36 hours. 
